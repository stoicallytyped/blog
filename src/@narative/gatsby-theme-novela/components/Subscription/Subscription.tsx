  ...
  return (
    <Section narrow>
      <SubscriptionContainer>
        <Content>
          <Heading>Hey! We've got a newsletter!</Heading>
          <Text>
            Your weekly dose of bite sized Android news and events delivered
            Monday mornings to kick off your week.
            <br />
            <br />
            Each issue contains TL;DRs of recent articles, a developer tool
            highlight, interview practice, and a stoic sentiment applied to tech
            careers.
            <br />
            <br />
            ...
            <br />
            <br />
            <a href="https://stoicallytyped.com/newsletter-announcement">
              <u>Read more about it here!</u>
            </a>
          </Text>
