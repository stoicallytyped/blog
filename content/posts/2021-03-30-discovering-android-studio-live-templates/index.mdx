---
title: "Understanding Android Studio Live Templates for Jetpack Compose"
slug: unlocking-the-power-of-live-templates-in-android-studio
author: Matt McKenna
date: 2021-04-20
hero: ./images/understanding-live-templates.png
...
<div className="Image__Medium">
  <img
    ...
    title="The Edit Tempalte Variables Window"
    alt="The Edit Tempalte Variables Window"
  />
</div>
...
### Automatically importing with Live Templates
...
Not all live templates should be accesible at all times. For instance, Kotlin live templates shouldn't be available in a Java context, but we can have more control than that! Let's look at the live template to create a function with no return type (`void`). 
...
Many of the code structures, syntax, and best practices in Compose UI are very repeatable which means there is a lot of opportunity to create live templates! Android Studio Arctic Fox comes with some Compose live templates, but lets add some common uses that aren't included.

##### Private Composable

|Abbreviation| Description | Shorten FQ Names |
|---|---|---|
| `pcomp` | "Create a private composable function" | ✅ |
...
|Abbrv.|Description|Shorten FQ Names|`$VAR$` Function|
|---|---|---|---|
| `remstate` | "Create a private composable function" | ✅ | `kotlinSuggestVariableName()` |
...
This live tempalte idea is from [Adam McNeilly](https://twitter.com/AdamMc331)!

| Abbreviation | Description | Shorten FQ Names |
|---|---|---|
| `dnprev` | "Create a day/night @Preview composable function" | ✅ |
...
Go create and play with some live templates! They are really fun to make and use in day to day development. If you need help with them or want to share what you've made reach out on Twitter [@matthewcmckenna](https://twitter.com/matthewcmckenna)! I'd love to see!
